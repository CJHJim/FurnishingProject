	...
	<meta http-equiv="expires" content="0" />
 	<script type="text/javascript">
	  ...
	  function quit(){
		...
		window.parent.location.href="admin/adminExit.html"
		}
	  }	
		...
		<div class="navbar">
			<div class="navbar-inner">
				<div class="container-fluid">
					<span id="teacher_title" style="height:70px;">
					<s:if test="#session.admin!=null">
							用户名：&nbsp;&nbsp;${admin.loginName}&nbsp;&nbsp;
							身份：&nbsp;&nbsp;
							<s:if test="#session.admin.isSuper==0">
								超级管理员
							</s:if>
							<s:else>
								操作员
						...
						<script type="text/javascript">
						    alert("您尚未登录本系统，请先登录！");
						    window.parent.location.href = "${pageContext.request.contextPath}/admin/adminLogin.jsp";	
						 </script>
						</s:else>
